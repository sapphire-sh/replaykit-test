...
namespace SA.iOS.AVFoundation.Internal {
    internal class ISN_AVNativeAPI : ISN_Singleton<ISN_AVNativeAPI>, ISN_iAVAPI
    {
        ...
        [DllImport("__Internal")] static extern string _ISN_AV_AudioSessionSetCategoryWithOptions(int category, int options);
        ...
        [DllImport("__Internal")] static extern int _ISN_AV_AudioSessionGetCategoryOptions();
        ...
        [DllImport("__Internal")] static extern IntPtr _ISN_CopyCGImageAtTime(string movieUrl, double seconds);
