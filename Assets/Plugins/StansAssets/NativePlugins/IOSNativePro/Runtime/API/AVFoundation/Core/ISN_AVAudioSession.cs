...
namespace SA.iOS.AVFoundation {
    ...
    public static class ISN_AVAudioSession
    {
        ...
        {
            get { return ISN_AVLib.API.AudioSessionCategory; }
        }
        ...
        /// </summary>
        public static ISN_AVAudioSessionCategoryOptions CategoryOptions
        {
            get { return ISN_AVLib.API.AudioSessionCategoryOptions; }
        }
        ...
        {
            get { return ISN_AVLib.API.OnAudioSessionRouteChange; }
        }
    }
}