...
namespace SA.iOS.AVFoundation.Internal
{
    ...
    internal class ISN_AVEditorAPI : ISN_iAVAPI
    {
        ...
        private ISN_AVAudioSessionCategoryOptions m_audioSessionCategoryOptions = ISN_AVAudioSessionCategoryOptions.MixWithOthers;
        ...
        {
            get { return m_audioSessionCategoryOptions; }
        }
