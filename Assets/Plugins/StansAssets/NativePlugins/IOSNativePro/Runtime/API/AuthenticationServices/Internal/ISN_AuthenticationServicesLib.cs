...
namespace SA.iOS.AuthenticationServices.Internal
{
    public static class ISN_AuthenticationServicesLib
    {
...
#if API_ENABLED
        [DllImport("__Internal")]
        public static extern ulong _ISN_ASAuthorizationController_initWithAuthorizationRequests(string authorizationRequests);
        [DllImport("__Internal")]
        public static extern void _ISN_ASAuthorizationController_performRequests(ulong hash);
        [DllImport("__Internal")]
        public static extern void _ISN_ASAuthorizationController_setDelegate(ulong hash, IntPtr didCompleteWithError, IntPtr didCompleteWithAuthorization);
#else
        public static ulong _ISN_ASAuthorizationController_initWithAuthorizationRequests(string authorizationRequests) { return ISN_NativeObject.k_NullObjectHash; }
