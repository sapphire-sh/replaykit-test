...
namespace SA.iOS.AuthenticationServices
{
    ...
    {
        [SerializeField] string m_User = string.Empty;
        [SerializeField] string m_State = string.Empty;
        [SerializeField] string m_AuthorizationCode = string.Empty;
        [SerializeField] string m_IdentityToken = string.Empty;
        [SerializeField] string m_Email = string.Empty;
        [SerializeField] ISN_NSPersonNameComponents m_FullName = null;
        ...
        /// The user’s name.
        /// </summary>
        public ISN_NSPersonNameComponents FullName
        {
