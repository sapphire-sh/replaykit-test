...
{
    [Serializable]
    internal class ISN_UIPickerControllerRequest 
    {
        ...
        [SerializeField] public ISN_UIImagePickerControllerCameraDevice m_CameraDevice = ISN_UIImagePickerControllerCameraDevice.Rear;
        [SerializeField] public ISN_UIModalPresentationStyle m_ModalPresentationStyle = ISN_UIModalPresentationStyle.Automatic;
    }
}