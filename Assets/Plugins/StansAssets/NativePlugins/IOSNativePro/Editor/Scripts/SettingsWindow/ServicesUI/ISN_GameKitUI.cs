...
namespace SA.iOS
{
    public class ISN_GameKitUI : ISN_ServiceSettingsUI
    {
        ...
        {
            get { return "GameKit offers features that you can use to create great social games."; }
        }

        protected override Texture2D Icon 
        {
            get { return SA_EditorAssets.GetTextureAtPath(ISN_Skin.ICONS_PATH + "GameKit_icon.png"); }
        }

        public override SA_iAPIResolver Resolver 
        {
            get { return ISN_Preprocessor.GetResolver<ISN_GameKitResolver>(); }
        }
