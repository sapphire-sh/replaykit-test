...
namespace SA.iOS
{
    ...
    {
        private GUIContent m_ProductIdDLabel = new GUIContent("ProductId[?]:", "A unique identifier that will be used for reporting. It can be composed of letters and numbers.");
        private GUIContent m_ProductTypeLabel = new GUIContent("Product Type[?]:", "Select the in-app purchase type you want to register");
        private GUIContent m_DisplayNameLabel = new GUIContent("Display Name[?]:", "This is the name of the In-App Purchase that will be seen by customers (if this is their primary language). For automatically renewable subscriptions, don’t include a duration in the display name. The display name can’t be longer than 75 characters.");
        ...
        private GUIContent m_PriceTierLabel = new GUIContent("Price Tier[?]:", "The retail price for this In-App Purchase subscription.");
        ...
        public override void OnAwake() 
        {
            ...
            AddFeatureUrl("Storefront", "https://unionassets.com/ios-native-pro/storefront-api-851");
        }

        public override string Title 
        {
            get { return "Store Kit"; }
        }

        public override string Description 
        {
            get { return "Support in-app purchases and interactions with the App Store."; }
        }

        protected override Texture2D Icon 
        {
            get { return SA_EditorAssets.GetTextureAtPath(ISN_Skin.ICONS_PATH + "StoreKit_icon.png"); }
        }

        public override SA_iAPIResolver Resolver 
        {
            get { return ISN_Preprocessor.GetResolver<ISN_StoreKitResolver>(); }
        }
